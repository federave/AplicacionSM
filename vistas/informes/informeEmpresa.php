...
require('obtenerDatosEmpresa.php');
...
$pdf->Text(100-$pdf->GetStringWidth("Informe de Venta: Empresa")/2,15,"Informe de Venta: Empresa");
...
$pdf->Ln();$pdf->Ln();
$pdf->Write(5,"Bidones de 20L Entregados por Dia: ".bcdiv($datosInforme->ProductosVendidos->Bidones20L+$datosInforme->EntregaAlquileres->Bidones20L+$datosInforme->ProductosBonificados->Bidones20L,$datosInforme->CantidadDeRepartos,2));
$pdf->Ln();$pdf->Ln();
$pdf->Write(5,"Bidones de 12L Entregados por Dia: ".bcdiv($datosInforme->ProductosVendidos->Bidones12L+$datosInforme->EntregaAlquileres->Bidones12L+$datosInforme->ProductosBonificados->Bidones12L,$datosInforme->CantidadDeRepartos,2));
