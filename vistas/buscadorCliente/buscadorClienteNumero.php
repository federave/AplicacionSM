...
?>
  ...
  <script type="text/javascript">
      ...
      function buscarClientesNumero()
      {
      if(document.getElementById("inputBusquedaNumero").value.length >= 1)
        {
        var parametros = "?datoBusqueda="+document.getElementById("inputBusquedaNumero").value;
        var url="../../controladores/buscarClientes/buscarClientesNumero.php" + parametros;
        var solicitud = new XMLHttpRequest();
        solicitud.addEventListener('load',respuestaBuscarClientesNumero,false);
        ...
        document.getElementById("divClientesEncontradosNumero").innerHTML="";
        document.getElementById("divClientesEncontradosNumero").appendChild(lista.getLista());
        }
      }

      function respuestaBuscarClientesNumero(respuesta)
      {
    ...
    <div class="text-center" >
      <label class="fuente" for="inputBusquedaNumero" style="font-size:18px;text-align:center;margin-bottom:12px">Ingrese datos de busqueda</label>
    </div>

    <div class=""style="align-items:center;width:100%;display:flex;justify-content:center;">
      <div class="" style="">
        <input type="text" name="" class="form-control" value="" onkeyup="buscarClientesNumero()" style="width:300px;font-size:19px;text-align:center" type="text" id="inputBusquedaNumero" value="">
      </div>
    </div>

    <div class="" style="align-items:center;width:100%;display:flex;justify-content:center;align-items:center;">
      <div id="divClientesEncontradosNumero" class="" style="width:100%;margin-top:20px;">
      </div>
    </div>
