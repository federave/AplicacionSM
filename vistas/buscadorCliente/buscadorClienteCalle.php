...
?>
  ...
  <script type="text/javascript">
      ...
      function buscarClientesCalle()
      {
      if(document.getElementById("inputBusquedaCalle").value.length >= 1)
        {
        var parametros = "?datoBusqueda="+document.getElementById("inputBusquedaCalle").value;
        var url="../../controladores/buscarClientes/buscarClientesCalle.php" + parametros;
        var solicitud = new XMLHttpRequest();
        solicitud.addEventListener('load',respuestaBuscarClientesCalle,false);
        ...
        document.getElementById("divClientesEncontradosCalle").innerHTML="";
        document.getElementById("divClientesEncontradosCalle").appendChild(lista.getLista());
        }
      }

      function respuestaBuscarClientesCalle(respuesta)
      {
    ...
    <div class="text-center" >
      <label class="fuente" for="inputBusquedaCalle" style="font-size:18px;text-align:center;margin-bottom:12px">Ingrese datos de busqueda</label>
    </div>

    <div class=""style="align-items:center;width:100%;display:flex;justify-content:center;">
      <div class="" style="">
        <input type="text" name="" class="form-control" value="" onkeyup="buscarClientesCalle()" style="width:300px;font-size:19px;text-align:center" type="text" id="inputBusquedaCalle" value="">
      </div>
    </div>

    <div class="" style="align-items:center;width:100%;display:flex;justify-content:center;align-items:center;">
      <div id="divClientesEncontradosCalle" class="" style="width:100%;margin-top:20px;">
      </div>
    </div>
