...
?>
  ...
  <script type="text/javascript">
      ...
      {
      if(document.getElementById("inputBusquedaId").value.length >= 1)
        {
        var parametros = "?datoBusqueda="+document.getElementById("inputBusquedaId").value;
        var url="../../controladores/buscarClientes/buscarClientesId.php" + parametros;
        var solicitud = new XMLHttpRequest();
        solicitud.addEventListener('load',respuestaBuscarClientesId,false);
        ...
        document.getElementById("divClientesEncontradosId").innerHTML="";
        document.getElementById("divClientesEncontradosId").appendChild(lista.getLista());
        }
      }

      function respuestaBuscarClientesId(respuesta)
      {
    ...
    <div class="text-center" >
      <label class="fuente" for="inputBusquedaId" style="font-size:18px;text-align:center;margin-bottom:12px">Ingrese datos de busqueda</label>
    </div>

    <div class=""style="align-items:center;width:100%;display:flex;justify-content:center;">
      <div class="" style="">
        <input type="text" name="" class="form-control" value="" onkeyup="buscarClientesId()" style="width:300px;font-size:19px;text-align:center" type="text" id="inputBusquedaId" value="">
      </div>
    </div>

    <div class="" style="align-items:center;width:100%;display:flex;justify-content:center;align-items:center;">
      <div id="divClientesEncontradosId" class="" style="width:100%;margin-top:20px;">
      </div>
    </div>
