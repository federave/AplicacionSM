...
class EntregaVertedor extends GenericoDiaRepartidor
{
      ...
      if(parent::abrirConexion())
          {
          $sql = "SELECT * FROM entregavertedores WHERE idcliente = '$idcliente' AND iddireccion = '$iddireccion' AND idrepartidor = '$idrepartidor' AND fecha = '$fecha'  ";
