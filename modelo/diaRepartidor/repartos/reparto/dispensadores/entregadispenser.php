...
class EntregaDispenser extends GenericoDiaRepartidor
{
      ...
      if(parent::abrirConexion())
          {
          $sql = "SELECT * FROM entregadispensers WHERE idcliente = '$idcliente' AND iddireccion = '$iddireccion' AND idrepartidor = '$idrepartidor' AND fecha = '$fecha'  ";
