...
class VentaVertedor extends GenericoDiaRepartidor
{
      ...
      if(parent::abrirConexion())
          ...
          $sql = "SELECT * FROM ventavertedores WHERE idcliente = '$idcliente' AND iddireccion = '$iddireccion' AND idrepartidor = '$idrepartidor' AND fecha = '$fecha'  ";
