...
class CambioDispenser extends GenericoDiaRepartidor
{
      ...
      if(parent::abrirConexion())
          {
          $sql = "SELECT * FROM cambiodispensers WHERE idcliente = '$idcliente' AND iddireccion = '$iddireccion' AND idrepartidor = '$idrepartidor' AND fecha = '$fecha'  ";
