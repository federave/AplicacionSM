...
class CambioVertedor extends GenericoDiaRepartidor
{
      ...
      if(parent::abrirConexion())
          {
          $sql = "SELECT * FROM cambiovertedores WHERE idcliente = '$idcliente' AND iddireccion = '$iddireccion' AND idrepartidor = '$idrepartidor' AND fecha = '$fecha'  ";
