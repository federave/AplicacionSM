...
if($conector->abrirConexion())
  ...
  $sql = "SELECT IdCliente,Nombre,Apellido,Telefono1 FROM Clientes WHERE Nombre LIKE '%$datoBusqueda%' OR Apellido LIKE '%$datoBusqueda%' OR Telefono1 LIKE '%$datoBusqueda%'";
