...
function datosAlquiler(&$xml,$idCliente,$idDireccion,$fecha)
{
...
if($conector->abrirConexion())
  ...
  if($tabla->num_rows>0)
      ...
      if($row["Estado_AcuerdoDispenser"]==1)
        {
        $alquiler = datosAlquiler($xml,$idCliente,$idDireccion,$fecha);
        }
...
function inactividad(&$xml,$idCliente,$idDireccion,$fecha)
{
